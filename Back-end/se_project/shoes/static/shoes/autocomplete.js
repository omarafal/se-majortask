var Autocomplete = function() {
    ...
    var s = function(t, e) {
            ...
            n(this, "handleKeyDown", (function(t) {
                    ...
                    switch (e) {
                        ...
                        case "Enter":
                            ...
                            s.selectedResult = s.results[s.selectedIndex] || s.selectedResult,
                                s.selectResult();
                            break;
                        case "Esc":
                        case "Escape":
            ...
            n(this, "updateResults", (function(t) {
                    ...
                    s.onLoading(),
                        s.search(t).then((function(t) {
                                e === s.searchCounter && (s.results = t,
                                    s.onLoaded(),
                                    0 !== s.results.length ? (s.selectedIndex = s.autoSelect ? 0 : -1,
                                        s.onUpdate(s.results, s.selectedIndex),
                                        s.showResults()) : s.hideResults())
                            }
                        ))
                }
            )),
        ...
        function n(e, s, i) {
            t(this, n),
                this.id = "".concat(i, "-result-").concat(e),
                this.class = "".concat(i, "-result"),
                this["data-result-index"] = e,
                this.role = "option",
            e === s && (this["aria-selected"] = "true")
        }
        var s, i, o;
        return s = n,
        (i = [{
    ...
    return function e(s) {
        ...
        t(this, e),
            ...
            n(this, "initialize", (function() {
                    ...
                    i.autocorrect && i.input.setAttribute("autocorrect", "on"),
                    ...
                    t && i.resultList.setAttribute(t.attribute, t.content),
                        i.resultList.style.position = "absolute",
                        i.resultList.style.zIndex = "1",
                        i.resultList.style.width = "100%",
                        i.resultList.style.boxSizing = "border-box",
                    i.resultList.id || (i.resultList.id = r("".concat(i.baseClass, "-result-list-"))),
                        ...
                        i.input.addEventListener("keydown", i.core.handleKeyDown),
                        i.input.addEventListener("focus", i.core.handleFocus),
                        i.input.addEventListener("blur", i.core.handleBlur),
                        i.resultList.addEventListener("mousedown", i.core.handleResultMouseDown),
                        i.resultList.addEventListener("click", i.core.handleResultClick),
                        i.updateStyle()
                }
            )),
            n(this, "destroy", (function() {
                    document.body.removeEventListener("click", i.handleDocumentClick),
                        i.input.removeEventListener("input", i.core.handleInput),
                        i.input.removeEventListener("keydown", i.core.handleKeyDown),
                        i.input.removeEventListener("focus", i.core.handleFocus),
                        i.input.removeEventListener("blur", i.core.handleBlur),
                        i.resultList.removeEventListener("mousedown", i.core.handleResultMouseDown),
                        i.resultList.removeEventListener("click", i.core.handleResultClick),
                        i.root = null,
                        i.input = null,
                        i.resultList = null,
                        i.getResultValue = null,
                        i.onUpdate = null,
                        i.renderResult = null,
                        i.core.destroy(),
                        i.core = null
            ...
            n(this, "handleUpdate", (function(t, e) {
                    i.resultList.innerHTML = "",
                        ...
                        i.input.setAttribute("aria-activedescendant", e > -1 ? "".concat(i.baseClass, "-result-").concat(e) : ""),
                    i.resetPosition && (i.resetPosition = !1,
                        i.position = a(i.input, i.resultList),
                        i.updateStyle()),
            ...
            n(this, "updateStyle", (function() {
                    i.root.dataset.expanded = i.expanded,
                        ...
                        i.resultList.style.visibility = i.expanded ? "visible" : "hidden",
                        i.resultList.style.pointerEvents = i.expanded ? "auto" : "none",
                        "below" === i.position ? (i.resultList.style.bottom = null,
                            i.resultList.style.top = "100%") : (i.resultList.style.top = null,
                            i.resultList.style.bottom = "100%")
                }
            )),
        ...
        E > 0 && (U.handleInput = c(U.handleInput, E)),
            this.core = U,
            this.initialize()
    }
}();
